...
public class PlayerManagerMixin {
    ...
    @Redirect(method = "respawnPlayer", at = @At(value = "NEW", target = "(Lnet/minecraft/registry/RegistryKey;Lnet/minecraft/registry/RegistryKey;JLnet/minecraft/world/GameMode;Lnet/minecraft/world/GameMode;ZZBLjava/util/Optional;I)Lnet/minecraft/network/packet/s2c/play/PlayerRespawnS2CPacket;"))
    public PlayerRespawnS2CPacket mtwSpoofDim(RegistryKey dimensionType, RegistryKey dimension, long sha256Seed, GameMode gameMode, GameMode previousGameMode, boolean debugWorld, boolean flatWorld, byte flag, Optional lastDeathPos, int portalCooldown, ServerPlayerEntity player, boolean alive) {
