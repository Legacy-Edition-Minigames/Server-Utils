...
public class SnowballKnockbackMod extends ModuleWConfig<SnowballKnockbackConfig> {
    ...
    public void registerCommands(CommandDispatcher<ServerCommandSource> dispatcher) {
        ...
        knockbackCommand.then(CommandManager.literal("knockback")
        ...
        eggKnockbackCommand.then(CommandManager.literal("knockback")
                .then(CommandManager.literal("set")
                        .then(CommandManager.argument("mult", FloatArgumentType.floatArg())
                                .executes(cmd -> {
        ...
        LiteralArgumentBuilder<ServerCommandSource> bobber = CommandManager.literal("bobberpull").requires(executor -> executor.hasPermissionLevel(2));

        bobber.then(CommandManager.literal("set").then(CommandManager.argument("value", FloatArgumentType.floatArg())
                        .executes(cmd -> {
